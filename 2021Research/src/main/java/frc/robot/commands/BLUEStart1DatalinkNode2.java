...
public class BLUEStart1DatalinkNode2 extends SequentialCommandGroup {
    public BLUEStart1DatalinkNode2(DriveSubsystem driveSubsystem, DatalinkSubsystem datalinkSubsystem, IntakeSubsystem intakeSubsystem) {
        addCommands(
