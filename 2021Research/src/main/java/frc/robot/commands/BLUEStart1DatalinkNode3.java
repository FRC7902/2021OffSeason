...
public class BLUEStart1DatalinkNode3 extends SequentialCommandGroup {
    public BLUEStart1DatalinkNode3(DriveSubsystem driveSubsystem, DatalinkSubsystem datalinkSubsystem, IntakeSubsystem intakeSubsystem) {
        addCommands(
